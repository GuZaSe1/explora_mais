...
<script>
    $(document).ready(function() {
        $('#dg_clientes').datagrid({
            url: '/explora_mais/api/listar_clientes_json.php',
            method: 'post',
            pagination: true,
            fitColumns: true,
            singleSelect: true,
    ...
    function abrirDialogInclusao() {
        ...
        $('#dlg').load('/explora_mais/controllers/controlar_cliente.php?form_only=1', function() {
            $.parser.parse('#dlg')
        })
    }
    ...
    function abrirDialogModificacao(cod_cliente) {
        ...
        $('#dlg').load('/explora_mais/controllers/controlar_cliente.php?form_only=1&cod_cliente=' + cod_cliente, function() {
            $.parser.parse('#dlg')
        })
    }
    ...
    function salvarCliente() {
        ...
        $.ajax({
            url: '/explora_mais/controllers/controlar_cliente.php',
            type: 'post',
            data: form.serialize(),
            dataType: 'json',
    ...
    function excluirCliente(cod_cliente) {
        $.messager.confirm('Confirmar Exclusão', 'Tem certeza que deseja excluir este cliente?', function(r) {
            if (r) {
                $.ajax({
                    url: '/explora_mais/controllers/excluir_cliente.php',
                    type: 'post',
                    data: {
