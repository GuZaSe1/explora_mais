    ...
    <div class="main-container">
        <div class="easyui-panel" title="Gerenciamento de Pontos Turísticos" style="padding:10px;">
            ...
            <table id="dg_pontos" class="easyui-datagrid" style="width:100%; height:450px"
                data-options="url:'/explora_mais/api/listar_pontos_turisticos_json.php', method:'post', pagination:true, fitColumns:true, singleSelect:true, onLoadSuccess: function() { $('.easyui-linkbutton').linkbutton(); }">
                <thead>
                    <tr>
...
<script>
    function abrirDialogInclusaoPonto() {
        ...
        $('#dlg-ponto').load('/explora_mais/controllers/controlar_ponto_turistico.php?form_only=1', function() {
    ...
    function abrirDialogModificacaoPonto(id) {
        ...
        $('#dlg-ponto').load('/explora_mais/controllers/controlar_ponto_turistico.php?form_only=1&id=' + id, function() {
            $.parser.parse('#dlg-ponto');
        });
    }
    ...
    function salvarPonto() {
        ...
        $.ajax({
            url: '/explora_mais/controllers/controlar_ponto_turistico.php',
            type: 'post',
            data: formData,
            dataType: 'json',
            processData: false,
    ...
    function excluirPonto(id) {
        $.messager.confirm('Confirmar Exclusão', 'Tem certeza que deseja excluir este ponto turístico?', function(r) {
            if (r) {
                $.ajax({
                    url: '/explora_mais/controllers/excluir_ponto_turistico.php',
                    type: 'post',
                    data: {
                        id: id
                    },
